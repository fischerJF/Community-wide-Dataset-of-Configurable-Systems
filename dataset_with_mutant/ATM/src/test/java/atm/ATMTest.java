...
public class ATMTest {
	...
	public void testDisplayMainMenu() throws Exception {
		...
		if(!Configuration.USER_INTERFACE) {
		    ...
		    if(Configuration.BALANCE_INQUIRY) {
		    	assertTrue(os.toString().contains("1 - View my balance"));
		    }
		    if (Configuration.WITHDRAWING) {
		      	assertTrue(os.toString().contains("2 - Withdraw cash"));
		    }
		    if (Configuration.DEPOSITING) {
		    	assertTrue(os.toString().contains("3 - Deposit funds"));
		    }
		}
	}
	@Test
	...
	public void authenticateUserTest() throws Exception {
		...
		if (!Configuration.USER_INTERFACE) {
		    ...
		    assertTrue(os.toString().contains("\nPlease enter your account number: "));
		    assertTrue(os.toString().contains("\nEnter your PIN: "));
			assertTrue(os.toString().contains("Invalid account number or PIN. Please try again."));
