...
public class GraphTest {
	...
	public void runSHORTEST_Test() {
		 ...
		 if (Configuration.SHORTEST) {
			 ...
			 g.run(aVertex);
			 assertTrue(os.toString().contains("<SHORTEST___ graph>")); 
	...
	public void runMSTKRUSKAL_Test() {
		 ...
		 if (Configuration.MSTKRUSKAL  && Configuration.WEIGHTED) {
			 ...
			 g.run(aVertex);
			 assertTrue(os.toString().contains("<MSTKRUSKAL___ graph>")); 
			 assertTrue(os.toString().contains("******************************************")); 
			 assertTrue(Main.testOps.toString().contains("Graph.run"));
	...
	public void runMSTPRIM_Test() {
		 ...
		 if (Configuration.MSTPRIM  && Configuration.WEIGHTED) {
			 ...
			 g.run(aVertex);
			 assertTrue(os.toString().contains("<MSTPRIM___ graph>")); 
			 assertTrue(os.toString().contains("******************************************")); 
			 assertTrue(Main.testOps.toString().contains("Graph.run"));
			 assertTrue(Main.testOps.toString().contains("MSTKRUSKAL display"));
			 assertTrue(os.toString().contains("Vertices "));
	...
	public void runCYCLE_Test() {
		...
		if (Configuration.CYCLE  && Configuration.WEIGHTED) {
			...
			g.run(aVertex);
			assertTrue(os.toString().contains("<CYCLE___>")); 
			assertTrue(os.toString().contains("******************************************")); 
			assertTrue(Main.testOps.toString().contains("Graph.run"));
...
//		 Configuration.WEIGHTED=true;
		 ...
		 if (Configuration.STRONGLYCONNECTED  ) {
			 ...
			 g.run(aVertex);
			 assertTrue(os.toString().contains("<STRONGLYCONNECTED___ graph>")); 
			 assertTrue(os.toString().contains("******************************************")); 
			 assertTrue(os.toString().contains("Vertices "));
		 }
	}
	...
	public void runBenchmarkTest() throws IOException {
		...
		g.runBenchmark(args);
		assertTrue(os.toString().contains("creating inFile")); 
	}
	...
	public void runBenchmarkNoFileTest() throws IOException {
		 ...
		 String args = "t";
		 g.runBenchmark(args);
		 assertTrue(os.toString().contains("Your file")); 
		 assertTrue(os.toString().contains("cannot be read")); 
	}
