...
//		assertEquals(MemberModifier.field(PL_Interface_impl.class, "verbose").get(pl),false);
	...
	public void mainTest() throws Throwable {
		...
		impl.start(1, 4);
		assertTrue(os.toString().contains("Started MinePump PL with Specification 1, Variation: 4"));
	}
	...
	public void randomSequenceOfActionTest() {
		...
		assertTrue(os.toString().contains("rise methChange start"));
		assertTrue(os.toString().contains("Pump(System:On,Pump:Off) Env(Water:high,Meth:CRIT)"));
		assertTrue(os.toString().contains("rise methChange start  rise methChange start"));
		assertTrue(os.toString().contains("Pump(System:On,Pump:Off) Env(Water:high,Meth:OK)"));
		assertTrue(os.toString().contains("rise methChange start  rise methChange start  rise methChange start"));
		assertTrue(os.toString().contains("Pump(System:On,Pump:Off) Env(Water:high,Meth:CRIT)"));
	...
	public void startTest() throws Throwable {
		...
		impl.start(4, 3);
		assertTrue(os.toString().contains("Started MinePump PL with Specification 4, Variation: 3 rise methChange start"));
		assertTrue(os.toString().contains("Pump(System:On,Pump:Off) Env(Water:high,Meth:CRIT)"));
		assertTrue(os.toString().contains("rise methChange start  rise methChange start"));
		assertTrue(os.toString().contains("Pump(System:On,Pump:Off) Env(Water:high,Meth:OK)"));
		assertTrue(os.toString().contains("rise methChange start  rise methChange start  rise methChange start"));
	...
	public void test_1() {
		...
		assertTrue(os.toString().contains("rise methChange start  rise methChange start  rise methChange start"));
		assertTrue(os.toString().contains("Pump(System:On,Pump:Off) Env(Water:high,Meth:CRIT)"));
		assertTrue(os.toString().contains("rise methChange start  rise methChange start  rise methChange start  rise methChange start"));
		assertTrue(os.toString().contains("Pump(System:On,Pump:Off) Env(Water:high,Meth:OK)"));
