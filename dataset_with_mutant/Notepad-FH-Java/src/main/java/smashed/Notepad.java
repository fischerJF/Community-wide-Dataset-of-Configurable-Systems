...
public class Notepad extends JFrame {
  ...
  public Notepad() {
    ...
    if (Configuration.UNDOREDOMENUBAR || Configuration.UNDOREDOTOOLBAR) {
  ...
  public void constructEditMenuBar() {
    if (Configuration.UNDOREDOMENUBAR) {
      ediT.add(undoAction);
      ediT.add(redoAction);
    }
  ...
  public void constructEditToolBar() {
    if (Configuration.UNDOREDOTOOLBAR) {
  ...
  public void constructMenuBar() {
    ...
    if (Configuration.EDITMENUBAR) {
      constructEditMenuBar();
    }

    if (Configuration.FORMATMENUBAR) {
    ...
    if (Configuration.PERSISTENCEMENUBAR) {
    ...
    if (Configuration.SEARCHMENUBAR) {
    ...
    if (Configuration.WORDCOUNTMENUBAR) {
  ...
  public void constructToolBar() {
    ...
    if (Configuration.EDITTOOLBAR) {
      toolBar.addSeparator();
      constructEditToolBar();
    }

    if (Configuration.FORMATTOOLBAR) {
      toolBar.addSeparator();
    ...
    if (Configuration.PERSISTENCETOOLBAR) {
      toolBar.addSeparator();
    ...
    if (Configuration.SEARCHTOOLBAR) {
      toolBar.addSeparator();
    ...
    if (Configuration.WORDCOUNTTOOLBAR) {
      toolBar.addSeparator();
