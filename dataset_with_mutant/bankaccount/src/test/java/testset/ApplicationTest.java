...
public class ApplicationTest {
	...
	public void setUp() { 
		...
		Configuration.interestestimation = true;
		...
		Configuration.transactionlog = true;
	...
	public void testNextYear() {
		...
		if(Configuration.interest) {
			...
			System.out.println("antes"+ a.account.interest);
			
			a.nextYear();
			System.out.println("depois"+a.account.interest);
