...
public class TestObeservability extends CompaniesTest {
	...
	public void createSampleCompany() {
		sampleCompany = (CompanyImpl) TestBasics.createSampleCompany(new BeanFactory());
	}
...
//	@Test //*
	public void testLogging() {
		...
		if (Configuration.LOGGING && Configuration.CUT_WHATEVER) {
	...
	public void testPrecedence() {
		...
		if (Configuration.PRECEDENCE && Configuration.CUT_NO_MANAGER) {
