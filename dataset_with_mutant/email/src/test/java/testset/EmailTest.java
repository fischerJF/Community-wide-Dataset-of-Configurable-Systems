...
public class EmailTest {
	...
	public void printMail__before__encryptTest() throws Exception {
		...
		assertTrue(os.toString().contains("ID:  1"));
//		assertTrue(os.toString().contains("FROM: 0"));
		assertTrue(os.toString().contains("TO: client__"));
		assertTrue(os.toString().contains("SUBJECT: test"));
		assertTrue(os.toString().contains("IS_READABLE true"));
		assertTrue(os.toString().contains("BODY: email system test"));
	}
	...
	public void printMail__before__signTest() throws Exception {
		...
		if (Configuration.ENCRYPT) {
			...
			assertTrue(os.toString().contains("ID:  1"));
//			assertTrue(os.toString().contains("FROM: 0"));
			assertTrue(os.toString().contains("TO: clientB@gmail.com"));
			assertTrue(os.toString().contains("SUBJECT: test"));
			assertTrue(os.toString().contains("IS_READABLE true"));
			assertTrue(os.toString().contains("BODY: email system test"));
			assertTrue(os.toString().contains("ENCRYPTED false"));
	...
	public void printMail__before__verifyTest() throws Exception {
		...
		if (Configuration.SIGN) {
			...
			assertTrue(os.toString().contains("SIGNED false"));
			assertTrue(os.toString().contains("SIGNATURE 0"));
		}
	}
	...
	public void printMail__role__verifyTest() throws Exception {
		...
		assertTrue(os.toString().contains("SIGNATURE VERIFIED false"));
	}
