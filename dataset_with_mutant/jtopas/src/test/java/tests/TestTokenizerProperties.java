...
public class TestTokenizerProperties extends JTopasTest implements TokenizerPropertyListener{
...
//    if (strTestName.equals("testDataHandlers")
//     || strTestName.equals("testAddingSequences")
//     || strTestName.equals("testAddingKeywords")
//     || strTestName.equals("testGenericProperties")
//        ) {
...
//  @Test
  ...
  // Members
  //
  TokenizerProperties     _properties     = null;
  TokenizerPropertyEvent  _currEvent      = null;
  char[]                  _currData       = new char[8192];
  int                     _currStartPos   = 0;
  int                     _currDataLength = 0;
