...
//				if(integer2 ==0) Configuration.gui=true;
//				if(integer2 ==1) Configuration.player=true;
				if(integer2 ==0) Configuration.skiptrack=true;
				if(integer2 ==1) Configuration.volumecontrol=true;
				if(integer2 ==2) Configuration.lightskin=true;
				if(integer2 ==3) Configuration.removetrack=true;
				if(integer2 ==4) Configuration.time=true;
				if(integer2 ==5) Configuration.reorderplaylist=true;
				if(integer2 ==6) Configuration.playlist=true;
				if(integer2 ==7) Configuration.darkskin=true;
				if(integer2 ==8) Configuration.saveandloadplaylist=true;
				if(integer2 ==9) Configuration.queuetrack=true;
				if(integer2 ==10) Configuration.progressbar=true;
				if(integer2 ==11) Configuration.mute=true;
				if(integer2 ==12) Configuration.showtime=true;
				if(integer2 ==13) Configuration.controlplayist=true;
				if(integer2 ==14) Configuration.showcover=true;
				if(integer2 ==15) Configuration.loadfolder=true;
				if(integer2 ==16) Configuration.shufflerepeat=true;
				if(integer2 ==17) Configuration.ogg=true;
				if(integer2 ==18) Configuration.mp3=true;
				if(integer2 ==19) Configuration.skins=true;
				if(integer2 ==20) Configuration.clearplaylist=true;
			}
