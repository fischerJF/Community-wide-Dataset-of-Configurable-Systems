...
public  class  Mp3Controller  extends AbstractAudioController {
	

	private Mp3MetaFile mp3metaFile;
	...
	public Mp3Controller(Mp3MetaFile mp3metaFile) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
		if (specifications.Configuration.mp3) {
			
			this.mp3metaFile = mp3metaFile;
			
			File file = new File(this.mp3metaFile.getFilename());
