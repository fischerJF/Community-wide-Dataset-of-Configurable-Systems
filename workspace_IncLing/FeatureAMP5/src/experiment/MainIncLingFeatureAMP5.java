...
import IncLing.*;
import IncLingSpecification.SpecificationFeatureAMP5;
import report.Record;
import report.RunListernerReport;
import specifications.Configuration;
import splat.FeatureAMP5Variables;
import testset.*;

public class MainIncLingFeatureAMP5 {
	...
	public void expRun() {
		...
		IncLing incling = new IncLing(1000, 10000, featureName,
				SpecificationFeatureAMP5.getSINGLETON(Configuration.tool), FeatureAMP5Variables.getSINGLETON());
		executeJunitTestCase(incling);
	}

	public static void main(String[] args) {
		MainIncLingFeatureAMP5 run = new MainIncLingFeatureAMP5();
		run.expRun();
