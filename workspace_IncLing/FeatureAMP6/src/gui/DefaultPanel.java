...
public  class  DefaultPanel  extends JPanel {
	...
	public void autoCreateGaps(boolean containerGaps, boolean normalGaps) {
		DefaultLayout l = (DefaultLayout)getLayout();
		l.setAutoCreateContainerGaps(containerGaps);
		l.setAutoCreateGaps(normalGaps);
	}
