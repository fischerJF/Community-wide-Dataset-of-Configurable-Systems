...
import IncLing.*;
import IncLingSpecification.SpecificationFeatureAMP9;
import report.Record;
import report.RunListernerReport;
import specifications.Configuration;
import splat.FeatureAMP9Variables;
import testset.*;

public class MainIncLingFeatureAMP9 {
	...
	public void expRun() {
		...
		featureName.add("WEICHBRODT_FEATUREAMP");
		featureName.add("REORDERPLAYLIST");
		featureName.add("PLAYLIST");
		featureName.add("TIMEDISPLAY");
		featureName.add("LIGHT");
		featureName.add("SHUFFLESKIPREMOVE");
		...
		IncLing incling = new IncLing(1000, 10000, featureName,
				SpecificationFeatureAMP9.getSINGLETON(Configuration.tool), FeatureAMP9Variables.getSINGLETON());
		executeJunitTestCase(incling);
	}

	public static void main(String[] args) {
		MainIncLingFeatureAMP9 run = new MainIncLingFeatureAMP9();
		run.expRun();
