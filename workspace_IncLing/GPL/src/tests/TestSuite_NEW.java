...
//		if (Configuration.SEARCH && Configuration.CYCLE && Configuration.DIRECTED && !Configuration.BFS) {
...
//		Configuration.SHORTEST=false;
		if (Configuration.SEARCH && Configuration.NUMBER && Configuration.CONNECTED && !Configuration.CYCLE
				&& !Configuration.BFS && !Configuration.MSTKRUSKAL && !Configuration.MSTPRIM && !Configuration.WEIGHTED
				&& !Configuration.UNDIRECTED && !Configuration.STRONGLYCONNECTED && !Configuration.SHORTEST) {
			Graph g = new Graph();
			Vertex v1 = new Vertex();
			v1.name = "v1";
	...
	public void test_run2() {
		...
		// System.out
		// .println(">>>>>METHODS COVERED- METHODS ACCESSING SHORTEST-PATH
		// FEATURE<<<<<");
...
//		Configuration.STRONGLYCONNECTED=false;
//		Configuration.SHORTEST=true;
		if (Configuration.SEARCH && Configuration.WEIGHTED && Configuration.SHORTEST && !Configuration.CYCLE
				&& !Configuration.BFS && !Configuration.MSTKRUSKAL && !Configuration.MSTPRIM && !Configuration.WEIGHTED
				&& !Configuration.UNDIRECTED && !Configuration.STRONGLYCONNECTED && Configuration.SHORTEST) {
	...
	public void test_run3() {
		...
		// System.out
		// .println(">>>>>METHODS COVERED- METHODS ACCESSING MSTPRIM,KRUSKAL
		// FEATURE<<<<<");
...
//		 Configuration.MSTPRIM=true;
		if (Configuration.SEARCH && Configuration.WEIGHTED && 
				Configuration.MSTKRUSKAL && Configuration.MSTPRIM ) {
			Graph g = new Graph();
			Vertex v1 = new Vertex();
			v1.name = "v1";
			v1.addWeight(1);
	...
	public void test_StrongComps() {
		...
		// System.out
		// .println(">>>>>METHODS COVERED- METHODS ACCESSING STRONGCOMPONENTS
		// FEATURE<<<<<");
		// System.out
...
//		Configuration.UNDIRECTED=false;
		...
		assertTrue((v1.finishTime > v2.finishTime) && (v2.finishTime > v3.finishTime));
...
//		Configuration.SEARCH=false;
		...
		assertTrue(Main.testOps.contains("Vertex.display, Display method covered with SEARCH=false"));
