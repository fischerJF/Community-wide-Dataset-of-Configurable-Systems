...
public class TokenizerProperty {
   ...
   * package {@link tests.de.susebox.jtopas} may define, set and return their own type 
   * constants.
   *
   ...
   * interfaces and classes in the package {@link tests.de.susebox.jtopas} may define,
