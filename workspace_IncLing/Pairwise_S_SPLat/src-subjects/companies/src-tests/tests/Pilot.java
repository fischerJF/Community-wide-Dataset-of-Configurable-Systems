...
//      CompaniesVariables.getSINGLETON().setLOGGING___(true);
      if (testName.getMethodName().equals("test7") || testName.getMethodName().equals("test6PreTrue")){
//        CompaniesVariables.getSINGLETON().setPRECEDENCE___(true);
  ...
  public void setup() {
    ...
    if (!(testName.getMethodName().equals("test5")) && !(testName.getMethodName().startsWith("test6")) &&
        !(testName.getMethodName().equals("test7")) )
    {
