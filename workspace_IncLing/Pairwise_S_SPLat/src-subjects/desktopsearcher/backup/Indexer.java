...
abstract class Indexer$$Single_Directory extends  Indexer$$Base  {
   ...
   ///< Liste aller verfuegbaren Content Handler
	 ...
	 * @param  luceneDir         Verzeichnis in dem der Index abgelegt wird
	 */
	public Indexer$$Single_Directory ( String luceneDir )  throws IndexerException{ super(luceneDir); }
}

public class Indexer extends  Indexer$$Single_Directory  {
	public void getAvailableContentHandlers() throws IndexerException{
   ...
   ///< Liste aller verfuegbaren Content Handler
	 ...
	 * @param  luceneDir         Verzeichnis in dem der Index abgelegt wird
	 */
	public Indexer ( String luceneDir )  throws IndexerException{ super(luceneDir); }
}