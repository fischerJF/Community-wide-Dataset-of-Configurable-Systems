...
public class Client {
	...
	// incoming emails are processed by this method before delivery.
	static void incoming__before__forward(Client client, Email msg) {
	...
	static void incoming__before__verify(Client client, Email msg) {
	...
	static void incoming__before__decrypt(Client client, Email msg) {
	...
	public static void incoming(Client client, Email msg) {
		if (splat.EmailVariables.getSINGLETON().isDECRYPT___()) {
	...
	static void outgoing__before__addressbook(Client client, Email msg) {
	...
	static void outgoing__role__addressbook(Client client, Email msg) {
		...
		if (!aliasReceivers.isEmpty()) {
			...
			// this alias (to addresses 1,2,...) address 0 will be handled by
			// the other methods
	...
	static void outgoing__before__sign(Client client, Email msg) {
	...
	public static Email sendEmail(Client sender, String receiverAddress,
		...
		if (receiver != null) {
			...
			throw new IllegalArgumentException("Receiver " + receiverAddress
					+ " Unknown");
		}
		return email; // die Zeile kommt von mir
	}
	...
	static Client[] clients = new Client[2000000];
	 ...
	 */
	public static Client getClientByAdress(String address) {
