...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    PrintStream log = new PrintStream(new File("results_email.txt"));
    ...
    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
        dataPath+"email_one_disabled.txt",
        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
        "--validate", "true" };
    System.out.println("--------------------------------------------------");
    /***** SPLat-Sampling *****/
    ...
    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
        dataPath+"email_most_enabled_disabled.txt",
        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
        "--validate", "true" };
    System.out.println("--------------------------------------------------");
    /***** SPLat-Sampling *****/
...
//    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
//        dataPath+"email_combination.txt",
//        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
//        "--validate", "true" };
//    System.out.println("--------------------------------------------------");
//    /***** SPLat-Sampling *****/
...
//        null, null, null, null, 
//        null, null, null, null, 
//        resultsRandom10, null, null, null);
    pr.calculateResults();
    pr.calculateTotal();
    pr.calculateAverage();
    // pr.calculateStats();
//    pr.calculateReachableConfs();
//    pr.calculateDataPlot("email");
  }
