...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    PrintStream log = new PrintStream(new File("results_notepad.txt"));
...
//        NotepadVariables.getSINGLETON());
    ...
    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
        dataPath+"notepad_one_enabled.txt",
      "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
      "--validate", "true" };
    System.out.println("--------------------------------------------------");
    /***** SPLat-Sampling *****/
    ...
    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
        dataPath+"notepad_one_disabled.txt",
        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
        "--validate", "true" };
    System.out.println("--------------------------------------------------");
    /***** SPLat-Sampling *****/
    ...
    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
        dataPath+"notepad_most_enabled_disabled.txt",
        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
        "--validate", "true" };
    System.out.println("--------------------------------------------------");
    /***** SPLat-Sampling *****/
...
//    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
//        dataPath+"notepad_combination.txt",
//        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
//        "--validate", "true" };
//    System.out.println("--------------------------------------------------");
//    /***** SPLat-Sampling *****/
