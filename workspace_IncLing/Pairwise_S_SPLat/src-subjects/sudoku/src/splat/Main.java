...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    PrintStream log = new PrintStream(new File("results_sudoku.txt"));
    ...
    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
        dataPath+"sudoku_one_disabled.txt",
        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
        "--validate", "true" };
    System.out.println("--------------------------------------------------");
    /***** SPLat-Sampling *****/
    ...
    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
        dataPath+"sudoku_most_enabled_disabled.txt",
        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
        "--validate", "true" };
    System.out.println("--------------------------------------------------");
    /***** SPLat-Sampling *****/
...
//    args = new String[] { "--testclass", "tests.TestAll", "--logfile",
//        dataPath+"sudoku_combination.txt",
//        "--shouldsample", "true", "--samplerate", "1", "--seed", "95729",
//        "--validate", "true" };
//    System.out.println("--------------------------------------------------");
//    /***** SPLat-Sampling *****/
