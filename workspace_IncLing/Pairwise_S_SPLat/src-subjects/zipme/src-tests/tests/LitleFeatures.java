...
public class LitleFeatures extends ZipMeTest {
   ...
   * -net.sf.zipme.CRC32.make_crc_table() -net.sf.zipme.CRC32.update(byte[],
   * int, int) -net.sf.zipme.ZipOutputStream.hook41()
   ...
   * 
   * -net.sf.zipme.GZIPOutputStream_hook22.GZIPOutputStream_hook22(GZIPOutputStream
   * , byte[])
   */
