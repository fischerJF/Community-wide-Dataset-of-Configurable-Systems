...
import Prop4J.And;
import Prop4J.AtLeast;
import Prop4J.Choose;
import Prop4J.Equals;
import Prop4J.Implies;
import Prop4J.Literal;
import Prop4J.Node;
import Prop4J.NodeReader;
import Prop4J.Not;
import Prop4J.Or;
import Prop4J.SatSolver; 
...
@Before
public void setUp() {
	Configuration.operators=true;
	Configuration.or=true;
	Configuration.negation=true;
	Configuration.atmost=true;
	Configuration.node_writer=true;
	Configuration.to_cnf=true;
	Configuration.prop4jspl=true;
	Configuration.extended=true;
	Configuration.tests=true;
	Configuration.equals=true;
	Configuration.node_reader=true;
	Configuration.implies=true;
	Configuration.atleast=true;
	Configuration.choose=true;
	Configuration.input_output=true;
	Configuration.and=true;
	Configuration.satsolver=true;
}
