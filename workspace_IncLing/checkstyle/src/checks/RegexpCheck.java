...
//        this.RegexpillegalPattern = illegalPattern;
    ...
    public void setDuplicateLimit(int duplicateLimit)
    {
        ...
        Configuration.RegexpcheckForDuplicates = (duplicateLimit > DEFAULT_DUPLICATE_LIMIT);
    }
    ...
    private void findMatch()
    {
        ...
        if (!foundMatch && !Configuration.RegexpillegalPattern && (matchCount == 0)) {
            logMessage(0);
        }
        else if (foundMatch) {
            ...
            if (Configuration.RegexpignoreComments) {
            ...
            if (!ignore) {
                matchCount++;
                if (Configuration.RegexpillegalPattern || (Configuration.RegexpcheckForDuplicates
            ...
            if ((errorCount < errorLimit)
                    && (ignore || Configuration.RegexpillegalPattern || Configuration.RegexpcheckForDuplicates))
            {
                findMatch();
            }
        }
    ...
    private void logMessage(int lineNumber)
    {
        ...
        if (Configuration.RegexpillegalPattern) {
