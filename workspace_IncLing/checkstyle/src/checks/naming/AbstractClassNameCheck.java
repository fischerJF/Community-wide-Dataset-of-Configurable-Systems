...
//	
	...
	public boolean isEnabled() {
		return Configuration.AbstractClassName;
	}
...
//    private boolean AbstractClassNameignoreName = true;
    ...
    {
    	Configuration. AbstractClassNameignoreModifier = value;
    }
    ...
    {
    	Configuration.AbstractClassNameignoreName = value;
    }
    ...
    private void visitClassDef(DetailAST ast)
    {
        ...
        if (isAbstract(ast)) {
            ...
            if (!Configuration.AbstractClassNameignoreName && !isMatchingClassName(className)) {
                log(ast.getLineNo(), ast.getColumnNo(),
                    ILLEGAL_ABSTRACT_CLASS_NAME, className, getFormat());
            }
        }
        else if (!Configuration.AbstractClassNameignoreModifier && isMatchingClassName(className)) {
            log(ast.getLineNo(), ast.getColumnNo(),
