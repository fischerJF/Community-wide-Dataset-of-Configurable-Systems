...
//	private static boolean EmptyLineSeparator = true;
	...
	public boolean isEnabled() {
		return Configuration.EmptyLineSeparator;
	}
    /**
            ...
            switch (astType) {
                case TokenTypes.VARIABLE_DEF:
                    if (isTypeField(ast) && !hasEmptyLineAfter(ast)) {
                        if (Configuration.EmptyLineSeparatorallowNoEmptyLineBetweenFields
                        ...
                        else if ((!Configuration.EmptyLineSeparatorallowNoEmptyLineBetweenFields || !Configuration.EmptyLineSeparatorallowMultipleEmptyLines)
                                 && nextToken.getType() != TokenTypes.RCURLY)
                        {
                            log(nextToken.getLineNo(), MSG_SHOULD_BE_SEPARATED,
                                 nextToken.getText());
                    ...
                    if (!Configuration.EmptyLineSeparatorallowMultipleEmptyLines && isTypeField(ast)
                ...
                case TokenTypes.IMPORT:
                    ...
                    if (!Configuration.EmptyLineSeparatorallowMultipleEmptyLines && isPrePreviousLineEmpty(ast)) {
                        log(ast.getLineNo(), MSG_MULTIPLE_LINES, ast.getText());
                    }
                    break;
