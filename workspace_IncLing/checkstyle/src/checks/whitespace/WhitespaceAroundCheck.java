...
//	private static boolean WhitespaceAround = true;
	...
	public boolean isEnabled() {
		return Configuration.WhitespaceAround;
	}
    /**
...
//        WhitespaceAroundAllowEmptyLoops = allow;
    ...
    public void visitToken(DetailAST ast)
    {
        ...
        if ((currentType == TokenTypes.COLON)) {
                ...
                || parentType == TokenTypes.LITERAL_CASE)
            {
                ...
                && Configuration.WhitespaceAroundIgnoreEnhancedForColon)
            {
                return;
            }
        }
        ...
        if (Configuration.WhitespaceAroundAllowEmptyTypes && (isEmptyType(ast, parentType))) {
            return;
        }
    ...
    {
        return Configuration.WhitespaceAroundAllowEmptyMethods
    ...
    {
        return Configuration.WhitespaceAroundAllowEmptyCtors
    ...
    {
        return Configuration.WhitespaceAroundAllowEmptyLoops
