...
//        final FileText copy = new FileText(null, fileText);
...
//    }
    ...
    public void testLineColumnAfterCopyConstructor() throws IOException {
        final String charsetName = StandardCharsets.ISO_8859_1.name();
        System.out.println(getPath("InputFileTextImportControl.xml"));
        final FileText fileText = new FileText(new File(getPath("InputFileTextImportControl.xml")),
                charsetName);
        final FileText copy = new FileText(null, fileText);
        final LineColumn lineColumn = copy.lineColumn(10);
        assertEquals("Invalid line", 17, lineColumn.getLine());
