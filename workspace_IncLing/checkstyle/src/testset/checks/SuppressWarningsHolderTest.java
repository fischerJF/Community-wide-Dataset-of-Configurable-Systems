...
import checks.whitespace.TypecastParenPadCheck;
//import checks.whitespace.AbstractParenPadCheck;
//import com.puppycrawl.tools.checkstyle.checks.whitespace.TypecastParenPadCheck;
import filters.SuppressWarningsFilter;
...
//    }
    ...
    public void testAstWithoutChildren() {
        ...
        try {
            ...
            assertEquals("Error message is unexpected",
                    "Identifier AST expected: null", ex.getMessage());
        }
    }
...
//    }
    ...
    private static AuditEvent createAuditEvent(String moduleId, int line, int column) throws CheckstyleException {
        final Checker source = new Checker();
