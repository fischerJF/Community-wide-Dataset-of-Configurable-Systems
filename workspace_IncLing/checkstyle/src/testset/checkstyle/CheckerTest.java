...
import checkstyle.PackageObjectFactory;
import checkstyle.TreeWalker;
...
import api.AuditListener;
import api.CheckstyleException;
import api.Configuration;
import api.Context;
import api.DetailAST;
//import api.ExternalResourceHolder;
import api.FileText;
import api.Filter;
import api.FilterSet;
import api.LocalizedMessage;
import api.MessageDispatcher;
import api.TokenTypes;
import checks.NewlineAtEndOfFileCheck;
import checks.TranslationCheck;
import checks.coding.HiddenFieldCheck;
import checkstyle.Checker;
import checkstyle.DefaultConfiguration;
import filters.SuppressionFilter;
import testset.internal.testmodules.DebugAuditAdapter;
import testset.internal.testmodules.DebugFilter;
//import testset.internal.testmodules.TestBeforeExecutionFileFilter;
import testset.internal.testmodules.TestFileSetCheck;
//import checkstyle.internal.testmodules.DebugAuditAdapter;
...
public class CheckerTest extends AbstractModuleTestSupport {
    ...
    protected String getPackageLocation() {
        return "test/resources/com/puppycrawl/tools/checkstyle/checker";
    }
...
*/
    @Test
    public void testNoClassLoaderNoModuleFactory() throws CheckstyleException {
        final Checker checker = new Checker();
