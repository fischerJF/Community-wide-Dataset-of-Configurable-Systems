...
import static checks.naming.AbstractNameCheck.MSG_INVALID_PATTERN;
...
import checks.blocks.LeftCurlyCheck;
import checks.coding.EmptyStatementCheck;
import checks.coding.HiddenFieldCheck;
//import checks.indentation.CommentsIndentationCheck;
import checks.javadoc.JavadocPackageCheck;
import checks.javadoc.JavadocParagraphCheck;
import checks.naming.ConstantNameCheck;
import checks.naming.MemberNameCheck;
import checks.naming.TypeNameCheck;
...
import filters.SuppressWithNearbyCommentFilter;
import filters.SuppressionCommentFilter;
