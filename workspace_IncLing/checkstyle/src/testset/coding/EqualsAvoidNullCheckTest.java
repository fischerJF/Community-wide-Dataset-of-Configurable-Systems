...
import static checks.coding.EqualsAvoidNullCheck.MSG_EQUALS_AVOID_NULL;
import static checks.coding.EqualsAvoidNullCheck.MSG_EQUALS_IGNORE_CASE_AVOID_NULL;

import org.abego.treelayout.util.DefaultConfiguration;
import org.junit.Assert;
import org.junit.Test;

import checks.coding.EqualsAvoidNullCheck;
...
public class EqualsAvoidNullCheckTest extends AbstractModuleTestSupport {
    ...
    public void testEqualsWithDefault() throws Exception {
        final checkstyle.DefaultConfiguration checkConfig =
            createModuleConfig(EqualsAvoidNullCheck.class);

        final String[] expected = {
            "37:27: " + getCheckMessage("equalsIgnoreCase.avoid.null"),
