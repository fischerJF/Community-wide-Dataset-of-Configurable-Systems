	...
	public void update(Observable o, Object arg) {
		if (o instanceof EmployeeImpl && arg instanceof String) {
			...
			if (((String)arg).equals("salary")) {
				...
				if (!e.getManager()) {// System.err.println("******salario do empregado");
				...
				} else { //System.err.println("******salario do gerente deve ser maior");
				...
				//	System.err.println("******salarios de todos empregados");
