...
public class ZipOutputStream extends DeflaterOutputStream implements
  ...
  public void hook41() throws IOException {
    if (Configuration.COMPRESS){
    }
    if (Configuration.DERIVATIVE_COMPRESS_CRC){
      crc.reset();
    }
  }

  public void hook42() throws IOException {
    if (Configuration.COMPRESS){
    }
    if (Configuration.DERIVATIVE_COMPRESS_CRC){
  ...
  public void hook43(byte[] b, int off, int len) throws IOException {
    if (Configuration.COMPRESS){
    }
    if (Configuration.DERIVATIVE_COMPRESS_CRC) {
